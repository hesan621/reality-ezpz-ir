...
```
bash <(curl -sL https://shorturl.at/wxNS0)
```
or (if the above command dosen't work):
```
bash <(curl -sL https://raw.githubusercontent.com/hesan621/reality-ezpz-ir/master/reality-ezpz.sh)
```
...
```
bash <(curl -sL https://shorturl.at/wxNS0) -m
```
